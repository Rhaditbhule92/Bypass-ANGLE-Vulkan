...
clear
echo "============================================="
echo " APPLYING ADVANCED GPU + ANGLE OPTIMIZATION..."
echo "============================================="

# ANGLE Vulkan Core & Backend
echo "[1] ANGLE Vulkan Core & Backend"
...
echo "[5] Properti GameManagerService"
...
# GPU Composition
echo "[6] GPU Composition / Rendering"
...
# Thermal
echo "[8] Disabling Thermal Controls"
...
# Watchdog
echo "[9] Disabling System Watchdog"
...
# WebView Vulkan
echo "[10] WebView Vulkan + GPU Raster"
...
echo "[11] Additional Rendering Enhancher (Opsional)"
...
# Vulkan Extensions
echo "[13] Enabling Vulkan Extensions"
...
# Final Tweaks
echo "[14] Final UI & Performance Tweaks"
...
# CPU & Network
echo "[15] CPU + Network Optimization"
setprop persist.sys.cpufreq.max 3750000
setprop persist.sys.cpufreq.min 1875000
setprop persist.sys.cpufreq.capacity 3750000
...
setprop persist.sys.kernel.fps.max 144
setprop persist.sys.gpu.max 950
setprop persist.sys.task_boost.max 1.5

# LTE Radio
echo "[16] Network / LTE Tweaks"
...
echo "[17] VoLTE & IMS Optimization"
